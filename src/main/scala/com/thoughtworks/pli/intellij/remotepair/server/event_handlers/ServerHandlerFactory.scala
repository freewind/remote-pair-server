...
object ServerHandlerFactory {
  type ServerHandler = ServerHandlerFactory#create
}

case class ServerHandlerFactory(clients: Clients, projects: Projects, parseEvent: ParseEvent, isSubPath: IsSubPath,
